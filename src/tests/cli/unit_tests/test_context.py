...
class TestMinitrinoContext:
    ...
    @patch("minitrino.context.EnvironmentVariables")
    @patch("minitrino.context.Modules")
    @patch("minitrino.context.CommandExecutor")
    @patch("minitrino.context.Cluster")
    @patch("minitrino.context.resolve_docker_socket")
    @patch("minitrino.context.docker.DockerClient")
    @patch("minitrino.context.docker.APIClient")
    ...
    def test_initialize_version_only(self):
        ...
        with patch("minitrino.context.EnvironmentVariables") as mock_env_class:
            mock_env_instance = MagicMock()
    ...
    @patch("minitrino.context.Cluster")
    @patch("minitrino.context.resolve_docker_socket")
    @patch("minitrino.context.docker")
    @patch("minitrino.context.utils")
