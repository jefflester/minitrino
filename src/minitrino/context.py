...
from minitrino.envvars import EnvironmentVariables
from minitrino.errors import MinitrinoError, UserError
from minitrino.exec.cmd import CommandExecutor
...
class MinitrinoContext:
    ...
    def __init__(self):
        ...
        self.logger: MinitrinoLogger = cast(
            MinitrinoLogger, logging.getLogger("minitrino")
        )
        self.cluster: Cluster = None  # type: ignore[assignment]
        self.env: EnvironmentVariables = None  # type: ignore[assignment]
        self.modules: Modules = None  # type: ignore[assignment]
        self.cmd_executor: CommandExecutor = None  # type: ignore[assignment]
