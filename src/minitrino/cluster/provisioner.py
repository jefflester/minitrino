...
class ClusterProvisioner:
    ...
    def provision(
        ...
        def _orchestrate():
            ...
            clusters_to_provision: list[None | dict] = [None]  # None = main cluster
    ...
    def _resolve_source_code(self) -> None:
        ...
        from minitrino.cluster.source import resolve_and_stage
    ...
    def _ensure_shared_network(self) -> None:
        ...
        assert self._ctx.docker_client is not None, "Docker client is not initialized"
        try:
