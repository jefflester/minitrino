...
def test_lib_install_command(temp_lib_dir):
    ...
    with patch('minitrino.core.context.MinitrinoContext', return_value=mock_ctx), \
...
def test_auto_install_library(temp_lib_dir) -> None:
    ...
    # Mock version checks
    with patch('minitrino.core.utils.cli_ver', return_value='1.0.0'), \
...
def test_auto_update_library(temp_lib_dir) -> None:
    ...
    with patch('minitrino.utils.cli_ver', return_value='1.0.0'), \
