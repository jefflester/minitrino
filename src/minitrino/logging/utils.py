...
from minitrino import logging as lg
...
def configure_logging(
    ...
    logger: lg.logger.MinitrinoLogger = cast(
        lg.logger.MinitrinoLogger, logging.getLogger("minitrino")
    )
    ...
    def _setup_handlers_and_formatters(
        ...
        logger._spinner = lg.spinner.Spinner(
            logger, logger._log_sink, always_verbose=always_verbose
        )
        from minitrino.logging.handler import MinitrinoLoggerHandler
