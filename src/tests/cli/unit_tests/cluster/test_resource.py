...
from minitrino.cluster.resource import ClusterResourceManager
...
class TestClusterResourceManager:
    ...
    @patch("minitrino.cluster.resource.MinitrinoContainer")
    @patch("minitrino.cluster.resource.MinitrinoNetwork")
    @patch("minitrino.cluster.resource.MinitrinoVolume")
    @patch("minitrino.cluster.resource.MinitrinoImage")
    ...
    def test_list_clusters_from_resources(self):
        ...
        cluster_names = manager._list_clusters(resources)  # type: ignore[arg-type]
