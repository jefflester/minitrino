...
class TestCluster:
    ...
    @patch("minitrino.cluster.cluster.ClusterValidator")
    @patch("minitrino.cluster.cluster.ClusterResourceManager")
    @patch("minitrino.cluster.cluster.ClusterPortManager")
    @patch("minitrino.cluster.cluster.ClusterOperations")
