...
from minitrino.logging.formatter import MinitrinoLogFormatter
...
class TestMinitrinoLogFormatter:
    ...
    @patch("minitrino.logging.formatter.get_terminal_width", return_value=80)
    ...
    def test_get_prefix_with_color(self):
        ...
        with patch("minitrino.logging.formatter.style") as mock_style:
    ...
    @patch("sys.stdout.isatty", return_value=True)
    @patch("minitrino.logging.formatter.get_terminal_width", return_value=20)
